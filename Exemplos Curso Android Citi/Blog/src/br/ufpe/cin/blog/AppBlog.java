...
btnVerComentario.setOnClickListener(new OnClickListener() {
 ...
 public void carregaTelaVerComentarios(int idPost){
 	...
 	btnProxComent.setOnClickListener(new OnClickListener() {
		
		public void onClick(View v) {
			try{
				dados.moveToNext();
		 		if(dados.isAfterLast()){
		 			return;
		 		}
	...
	btnAntComent.setOnClickListener(new OnClickListener() {
