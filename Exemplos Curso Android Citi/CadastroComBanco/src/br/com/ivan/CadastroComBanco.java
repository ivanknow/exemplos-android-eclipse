...
public class CadastroComBanco extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        banco.execSQL("CREATE TABLE if not exists tb_pessoa2 (id INTEGER NOT NULL, nome CHAR(255),profissao VARCHAR(255),idade NUMERIC NOT NULL,PRIMARY KEY (id)) ");
  ...
  //INICIO
    public void carregaTelaListar(){
    	...
    	try{
    		...
    		dados = banco.query("tb_pessoa2",new String[]{"id","nome","idade","profissao"}, null,null,null,null,null);
    		dados.moveToFirst();
    		ETnome = (EditText) findViewById(R.listar.tvnome);
    		ETidade = (EditText) findViewById(R.listar.tvidade);
    		ETprof = (EditText) findViewById(R.listar.tvprof);
    		ETnome.setText(dados.getString(dados.getColumnIndex("nome")));
    		ETidade.setText(dados.getString(dados.getColumnIndex("idade")));
    		ETprof.setText(dados.getString(dados.getColumnIndex("profissao")));
